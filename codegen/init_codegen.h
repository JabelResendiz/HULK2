...
typedef struct LLVMCoreContext
{
    ...
    LLVMValueRef strcpy_func; LLVMTypeRef strcpy_func_type;
    LLVMValueRef strcat_func; LLVMTypeRef strcat_func_type;
    LLVMValueRef strlen_func; LLVMTypeRef strlen_func_type;
    LLVMValueRef sqrt_func; LLVMTypeRef sqrt_func_type;
    LLVMValueRef sin_func; LLVMTypeRef sin_func_type;
    LLVMValueRef cos_func; LLVMTypeRef cos_func_type;
    LLVMValueRef log_func; LLVMTypeRef log_func_type;
    LLVMValueRef exp_func; LLVMTypeRef exp_func_type;
    LLVMValueRef rand_func; LLVMTypeRef rand_func_type;
    LLVMValueRef pow_func; LLVMTypeRef pow_func_type;
    LLVMValueRef fmod_func; LLVMTypeRef fmod_func_type;
    LLVMValueRef snprintf_func; LLVMTypeRef snprintf_func_type;
    LLVMValueRef strcmp_func; LLVMTypeRef strcmp_func_type;
