...
/**
 * @brief Procesa un miembro de tipo (atributo o método)
 * @param member_node Nodo "TypeMember" del CST
 * @return ASTNode* Nodo función correspondiente al miembro
 */
ASTNode *process_type_member(CSTNode *member_node);

/**
 * @brief Procesa el cuerpo de una función
 * @param body_node Nodo "FunctionBody" del CST
 * @return ASTNode* Nodo expresión o bloque del cuerpo
 */
